...
class AddAminOldPerScreen extends StatelessWidget {
  AddAminOldPerScreen({super.key});

  final MenageOldPaperController adminOldPaperCntrller =
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomTextField(
                            controller: AppTextfieldControllers.adminOldPapereName,
                            label: 'Enter Paper Details',
                            hintText: 'Paper Details',
                          ...
                          CustomTextField(
                            controller: AppTextfieldControllers.adminOldpaperLink,
                            label: 'Enter Paper Website Link',
                            hintText: 'Web Link',
                            keyboardType: TextInputType.text,
                            suffixIcon: const Icon(Icons.abc),
                            prefixIcon: const Icon(Icons.abc),
